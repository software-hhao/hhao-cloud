...
/**
 * GenericImplFilter:consumer端是泛化调用才启用。和provider端的GenericFilter配合使用。
 * Order越小，越早调用
 *
 * @author Wang
 * @since 2022/3/18 10:06
 */
@Activate(group = CONSUMER, order = Integer.MIN_VALUE)
public class CustomConsumeFilter implements ClusterFilter, ClusterFilter.Listener {
    private ApplicationModel applicationModel;
    private Set<PenetrateAttachmentSelector> supportedSelectors;

    public CustomConsumeFilter(ApplicationModel applicationModel) {
